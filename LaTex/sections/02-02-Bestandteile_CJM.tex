\subsection{Bestandteile einer Customer Journey Map [Tim Boeckel]} 
...
Die Person \textit{User} hat hierbei keine überwiegend kommerziellen Interessen und sollte neutral betrachtet werden.
\newline
\newline
\textbf{Journey:} \newline
...
Die \textit{Actual Journey} wiederum bezeichnet die tatsächliche Journey des Users. Diese beschreibt vor allem,
wie der User die Journey wahrgenommen hat und welche Probleme oder Wünsche bei der Nutzung der Diensteleistungen auftraten.
...
negative Emotionen oder unangenehme Situationen für diesen zu vermeiden. 
\newline
\newline
\textbf{Channel:}\newline
