\subsection{Vorteile von Customer Journey Maps [Tim Boeckel]}
...
\subsubsection{Vorteile für User durch die Nutzung von CJMs [Tim Boeckel]}
...
ein Produkt, welches sie sowieso schon verwenden, hin zu ihren Bedürfnissen zu verändern. Dies spart Usern die mühevolle Migration zu einem neuen Produkt,
...
des Users sehr gut abgebildet werden können. Subjektive Wahrnehmung, die etwa in ein User-Diary oder ein semi-strukturiertes Interview gut integrierbar ist,
wird durch herkömmliche Datenanalysen vernachlässigt. Dies führt dazu, dass auch einzelne Meinungen von Usern nicht untergehen und zu wertvollen Ideen oder Anstößen
...
\subsubsection{Vorteile für Unternehmen durch die Nutzung von CJMs [Tim Boeckel]}
Trotz des User-fokusierten Designanspruchs ergeben sich bei der Nutzung von Customer Journey Maps auch Vorteile für Unternehmen.  
...
Journey Maps für Unternehmen sehr positiv. Mithilfe einer CJM lässt sich beispielsweise nicht nur der Werbeprozess für ein Produkt oder einen Prozess - genannt Pre-Service - abbilden
,sondern auch der tatsächliche Nutzungsprozess dessen. So lassen sich sehr langwierige Prozessketten kompakt visualisieren. 
Diese Visualisierung unterstützt im Anschluss wiederum das unternehmensinterne Verständnis für das Produkt-Ökosystem.
Dieses kann nämlich gerade bei größeren Unternehmen sehr komplex und unüberschaubar werden.
