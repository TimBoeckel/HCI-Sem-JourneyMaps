...
\maketitle{Customer Journey Maps (Times 24; 142  t above; flush left):}
{Sub-title (Times 18; 2 Pt above; flush left)}

\author{Sergej Gelver (Times 14; 12 Pt above; flush left)}
       {Matrikelnummer (max. 1 line; Times 12; flush left)}
       {Mail (max. 1 line; Times 12; flush left)}

\author{Tim Böckel (Times 14; 12 Pt above; flush left)}
       {Matrikelnummer (max. 1 line; Times 12; flush left)}
       {tim.boeckel@stud.uni-bamberg.de (max. 1 line; Times 12; flush left)}



\begin{abstract}
       Diese Arbeit beschäftigt sich mit der Erstellung und der Funktionsweise von Customer Journey Maps. Es werden die Phasen einer Customer Journey Map,
       sowie methodische Ansätze zur Gewinnung von Informationen aufgezeigt. 
       Zusätzlich wird beispielhaft die Modellierung einer Customer Journey Map skizziert und eventuelle Vorteile die sich aus der Nutzung dieser ergeben diskutiert. 
\end{abstract}
...
\clearpage
\section{Einleitung}
\input{sections/01-Einleitung.tex}



\section{Hauptteil}
\input{sections/02-02-Bestandteile_CJM.tex}
\input{sections/02-03-Methoden.tex}
\input{sections/02-04-Modellierung.tex}
\input{sections/02-05-Einsatz_Praxis.tex}
...
% AUSKOMMENTIERT ZUM KOPIEREN WENN NÖTIG
...
%\begin{figure}[htb]
%  \begin{center}
%  \includegraphics{image/CML_Seminar_Template_fig1}
%  \end{center}
...
\textbf{Autorenschaft - Authorship}

\bigbreak

\textbf{Autorenschaft}

Ich erkl{\"a}re hiermit, dass ich die vorstehende Arbeit selbstst{\"a}ndig verfasst und keine anderen als die angegebenen Quellen und Hilfsmittel benutzt habe.
...
I hereby declare that I
 have written this work independently and have not used any other sources and aids than those indicated.
